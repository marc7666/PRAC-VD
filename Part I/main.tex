...
\begin{itemize}
    ...
    \item Data de creació de les dades: 18 de març de 2020
    \item Darrera actualització de les dades: 17 de novembre de 2025
    \item Regitre més antic: 1 de gener de 1991
...
\begin{itemize}
    ...
    \item Regitre més antic: 1 de gener de 2015
    \item Registre més recent: 17 de novembre de 2025
...
\end{itemize}
Com es pot observar en les mètriques del \textit{dataset} que s'utilitzarà en la segona part de la pràctica, aquest consta de 1.402.163 de files i 40 columnes (les del \textit{dataset} original) que combinen variables numèriques, tipus punt, textuals i de tipus segell de temps flotant. \newline
